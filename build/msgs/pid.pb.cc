...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.PID)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.PID)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.PID)
  return false;
#undef DO_
}
...
void PID::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.PID)
  // optional double target = 1 [default = 0];
  if (has_target()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.PID)
}

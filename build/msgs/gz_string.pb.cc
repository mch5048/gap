...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.GzString)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.GzString)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.GzString)
  return false;
#undef DO_
}
...
void GzString::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.GzString)
  // required string data = 1;
  if (has_data()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->data().data(), this->data().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.GzString)
}

...
void protobuf_AddDesc_gui_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "era\022#\n\006plugin\030\003 \003(\0132\023.gazebo.msgs.Plugin", 160);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.GUI)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.GUI)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.GUI)
  return false;
#undef DO_
}
...
void GUI::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.GUI)
  // optional bool fullscreen = 1;
  if (has_fullscreen()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.GUI)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.PointCloud)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.PointCloud)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.PointCloud)
  return false;
#undef DO_
}
...
void PointCloud::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.PointCloud)
  // repeated .gazebo.msgs.Vector3d points = 1;
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.PointCloud)
}

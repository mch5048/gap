...
void protobuf_AddDesc_camerasensor_2eproto() {
  ...
  ::gazebo::msgs::protobuf_AddDesc_distortion_2eproto();
...
void CameraSensor::InitAsDefaultInstance() {
  ...
  distortion_ = const_cast< ::gazebo::msgs::Distortion*>(&::gazebo::msgs::Distortion::default_instance());
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.CameraSensor)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.CameraSensor)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.CameraSensor)
  return false;
#undef DO_
}
...
void CameraSensor::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.CameraSensor)
  // optional double horizontal_fov = 1;
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.CameraSensor)
}
...
void CameraSensor::MergeFrom(const CameraSensor& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_distortion()) {
      mutable_distortion()->::gazebo::msgs::Distortion::MergeFrom(from.distortion());
    }
  }
...
bool CameraSensor::IsInitialized() const {
  ...
  if (has_distortion()) {
    if (!this->distortion().IsInitialized()) return false;
  }
  return true;
}

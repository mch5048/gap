...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.ForceTorque)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.ForceTorque)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.ForceTorque)
  return false;
#undef DO_
}
...
void ForceTorque::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.ForceTorque)
  // repeated .gazebo.msgs.JointWrench wrench = 1;
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.ForceTorque)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.LogStatus.LogFile)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.LogStatus.LogFile)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.LogStatus.LogFile)
  return false;
#undef DO_
}
...
void LogStatus_LogFile::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.LogStatus.LogFile)
  // optional string uri = 1;
  if (has_uri()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->uri().data(), this->uri().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.LogStatus.LogFile)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:gazebo.msgs.LogStatus)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.LogStatus)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.LogStatus)
  return false;
#undef DO_
}
...
void LogStatus::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.LogStatus)
  // optional .gazebo.msgs.Time sim_time = 1;
  if (has_sim_time()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.LogStatus)
}

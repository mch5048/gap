...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.PosesStamped)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.PosesStamped)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.PosesStamped)
  return false;
#undef DO_
}
...
void PosesStamped::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.PosesStamped)
  // required .gazebo.msgs.Time time = 1;
  if (has_time()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.PosesStamped)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.WirelessNodes)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.WirelessNodes)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.WirelessNodes)
  return false;
#undef DO_
}
...
void WirelessNodes::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.WirelessNodes)
  // repeated .gazebo.msgs.WirelessNode node = 1;
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.WirelessNodes)
}

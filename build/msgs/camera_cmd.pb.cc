...
void protobuf_AddDesc_camera_5fcmd_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "aCmd\022\024\n\014follow_model\030\001 \001(\t", 66);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.CameraCmd)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.CameraCmd)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.CameraCmd)
  return false;
#undef DO_
}
...
void CameraCmd::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.CameraCmd)
  // optional string follow_model = 1;
  if (has_follow_model()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->follow_model().data(), this->follow_model().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.CameraCmd)
}

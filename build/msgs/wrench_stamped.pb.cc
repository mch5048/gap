...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.WrenchStamped)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.WrenchStamped)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.WrenchStamped)
  return false;
#undef DO_
}
...
void WrenchStamped::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.WrenchStamped)
  // required .gazebo.msgs.Time time = 1;
  if (has_time()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.WrenchStamped)
}

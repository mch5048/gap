...
void protobuf_AssignDesc_heightmapgeom_2eproto() {
  ...
  static const int HeightmapGeom_offsets_[11] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(HeightmapGeom, sampling_),
  };
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[8 / 32] & 1792) {
    ZR_(use_terrain_paging_, sampling_);
    if (has_filename()) {
      if (filename_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        filename_->clear();
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_sampling;
        break;
      }

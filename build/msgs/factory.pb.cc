...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Factory)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Factory)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Factory)
  return false;
#undef DO_
}
...
void Factory::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Factory)
  // optional string sdf = 1;
  if (has_sdf()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->sdf().data(), this->sdf().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Factory)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.WirelessNode)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.WirelessNode)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.WirelessNode)
  return false;
#undef DO_
}
...
void WirelessNode::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.WirelessNode)
  // required string essid = 1;
  if (has_essid()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->essid().data(), this->essid().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.WirelessNode)
}

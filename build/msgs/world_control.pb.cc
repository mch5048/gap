...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.WorldControl)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.WorldControl)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.WorldControl)
  return false;
#undef DO_
}
...
void WorldControl::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.WorldControl)
  // optional bool pause = 1;
  if (has_pause()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.WorldControl)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Subscribe)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Subscribe)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Subscribe)
  return false;
#undef DO_
}
...
void Subscribe::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Subscribe)
  // required string topic = 1;
  if (has_topic()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->topic().data(), this->topic().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Subscribe)
}

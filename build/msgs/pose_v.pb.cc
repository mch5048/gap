...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Pose_V)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Pose_V)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Pose_V)
  return false;
#undef DO_
}
...
void Pose_V::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Pose_V)
  // repeated .gazebo.msgs.Pose pose = 1;
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Pose_V)
}

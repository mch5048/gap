...
void protobuf_AssignDesc_surface_2eproto() {
  ...
  static const int Surface_offsets_[13] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Surface, elastic_modulus_),
  };
  Surface_reflection_ =
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 12: {
        ...
        if (input->ExpectTag(105)) goto parse_elastic_modulus;
        break;
      }
...
void Surface::Swap(Surface* other) {
  if (other != this) {
    ...
    std::swap(elastic_modulus_, other->elastic_modulus_);

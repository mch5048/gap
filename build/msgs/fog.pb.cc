...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Fog)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Fog)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Fog)
  return false;
#undef DO_
}
...
void Fog::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Fog)
  // optional .gazebo.msgs.Fog.FogType type = 1;
  if (has_type()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Fog)
}

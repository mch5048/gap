...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.PoseStamped)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.PoseStamped)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.PoseStamped)
  return false;
#undef DO_
}
...
void PoseStamped::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.PoseStamped)
  // required .gazebo.msgs.Time time = 1;
  if (has_time()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.PoseStamped)
}

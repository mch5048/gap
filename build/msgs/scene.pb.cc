...
void protobuf_AssignDesc_scene_2eproto() {
  ...
  static const int Scene_offsets_[11] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Scene, origin_visual_),
  };
  Scene_reflection_ =
...
void protobuf_AddDesc_scene_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "Joint\022\025\n\rorigin_visual\030\013 \001(\010", 428);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Scene)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 10: {
        ...
        if (input->ExpectTag(82)) goto parse_joint;
        if (input->ExpectTag(88)) goto parse_origin_visual;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Scene)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Scene)
  return false;
#undef DO_
}
...
void Scene::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Scene)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // optional bool origin_visual = 11;
  if (has_origin_visual()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(11, this->origin_visual(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Scene)
}
...
::google::protobuf::uint8* Scene::SerializeWithCachedSizesToArray(
  ...
  // optional bool origin_visual = 11;
  if (has_origin_visual()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(11, this->origin_visual(), target);
  }
...
void Scene::Swap(Scene* other) {
  if (other != this) {
    ...
    std::swap(origin_visual_, other->origin_visual_);

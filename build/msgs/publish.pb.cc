...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Publish)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Publish)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Publish)
  return false;
#undef DO_
}
...
void Publish::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Publish)
  // required string topic = 1;
  if (has_topic()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->topic().data(), this->topic().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Publish)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Request)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Request)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Request)
  return false;
#undef DO_
}
...
void Request::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Request)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Request)
}

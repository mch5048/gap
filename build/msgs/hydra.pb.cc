...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Hydra.Paddle)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Hydra.Paddle)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Hydra.Paddle)
  return false;
#undef DO_
}
...
void Hydra_Paddle::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Hydra.Paddle)
  // required .gazebo.msgs.Pose pose = 1;
  if (has_pose()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Hydra.Paddle)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Hydra)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Hydra)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Hydra)
  return false;
#undef DO_
}
...
void Hydra::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Hydra)
  // required .gazebo.msgs.Hydra.Paddle right = 1;
  if (has_right()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->right(), output);
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Hydra)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Shadows)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Shadows)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Shadows)
  return false;
#undef DO_
}
...
void Shadows::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Shadows)
  // optional .gazebo.msgs.Shadows.ShadowType type = 5;
  if (has_type()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Shadows)
}

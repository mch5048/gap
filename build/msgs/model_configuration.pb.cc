...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.ModelConfiguration)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.ModelConfiguration)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.ModelConfiguration)
  return false;
#undef DO_
}
...
void ModelConfiguration::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.ModelConfiguration)
  // required .gazebo.msgs.Time time = 1;
  if (has_time()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.ModelConfiguration)
}

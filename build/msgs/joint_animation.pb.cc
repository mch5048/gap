...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.JointAnimation.Joint)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.JointAnimation.Joint)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.JointAnimation.Joint)
  return false;
#undef DO_
}
...
void JointAnimation_Joint::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.JointAnimation.Joint)
  // repeated string name = 1;
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.JointAnimation.Joint)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:gazebo.msgs.JointAnimation)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.JointAnimation)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.JointAnimation)
  return false;
#undef DO_
}
...
void JointAnimation::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.JointAnimation)
  // required string model_name = 1;
  if (has_model_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->model_name().data(), this->model_name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.JointAnimation)
}

...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.PoseAnimation)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.PoseAnimation)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.PoseAnimation)
  return false;
#undef DO_
}
...
void PoseAnimation::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.PoseAnimation)
  // required string model_name = 1;
  if (has_model_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->model_name().data(), this->model_name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.PoseAnimation)
}

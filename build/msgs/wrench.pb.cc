...
void Wrench::InitAsDefaultInstance() {
  ...
  force_offset_ = const_cast< ::gazebo::msgs::Vector3d*>(&::gazebo::msgs::Vector3d::default_instance());
}
...
bool Wrench::IsInitialized() const {
  ...
  if (has_force_offset()) {
    if (!this->force_offset().IsInitialized()) return false;
  }
  return true;
}

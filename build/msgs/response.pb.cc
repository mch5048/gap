...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Response)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Response)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Response)
  return false;
#undef DO_
}
...
void Response::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Response)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Response)
}

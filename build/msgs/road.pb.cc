...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Road)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Road)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Road)
  return false;
#undef DO_
}
...
void Road::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Road)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Road)
}

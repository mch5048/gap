...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.TopicInfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.TopicInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.TopicInfo)
  return false;
#undef DO_
}
...
void TopicInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.TopicInfo)
  // required string msg_type = 1;
  if (has_msg_type()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->msg_type().data(), this->msg_type().length(),
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.TopicInfo)
}

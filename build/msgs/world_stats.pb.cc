...
void protobuf_AssignDesc_world_5fstats_2eproto() {
  ...
  static const int WorldStatistics_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(WorldStatistics, log_playback_stats_),
  };
...
void protobuf_AddDesc_world_5fstats_2eproto() {
  ...
  ::gazebo::msgs::protobuf_AddDesc_log_5fplayback_5fstats_2eproto();
...
void WorldStatistics::InitAsDefaultInstance() {
  ...
  log_playback_stats_ = const_cast< ::gazebo::msgs::LogPlaybackStatistics*>(&::gazebo::msgs::LogPlaybackStatistics::default_instance());
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.WorldStatistics)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_log_playback_stats;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.WorldStatistics)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.WorldStatistics)
  return false;
#undef DO_
}
...
void WorldStatistics::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.WorldStatistics)
  // required .gazebo.msgs.Time sim_time = 2;
  if (has_sim_time()) {
  ...
  if (has_log_playback_stats()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      8, this->log_playback_stats(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.WorldStatistics)
}
...
::google::protobuf::uint8* WorldStatistics::SerializeWithCachedSizesToArray(
  ...
  if (has_log_playback_stats()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        8, this->log_playback_stats(), target);
  }
...
void WorldStatistics::MergeFrom(const WorldStatistics& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_log_playback_stats()) {
      mutable_log_playback_stats()->::gazebo::msgs::LogPlaybackStatistics::MergeFrom(from.log_playback_stats());
    }
  }
...
bool WorldStatistics::IsInitialized() const {
  ...
  if (has_log_playback_stats()) {
    if (!this->log_playback_stats().IsInitialized()) return false;
  }
  return true;
}
...
void WorldStatistics::Swap(WorldStatistics* other) {
  if (other != this) {
    ...
    std::swap(log_playback_stats_, other->log_playback_stats_);
